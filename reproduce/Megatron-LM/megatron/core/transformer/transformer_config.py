...
class TransformerConfig(ModelParallelConfig):
    ...
    """If True, cast Q/K and rotary frequencies to FP32 for RoPE, then cast the
    rotated Q/K back to their input dtype. This is independent of
    ``apply_rope_fusion`` so an FP32-capable fused backend remains accelerated."""
