...
②  前向反向调度：通过调整流水线并行过程中前向反向计算的顺序，结合多流异步通信机制，压缩流水线稳态气泡，提升训练性能。
...
PP自动并行内存优化模块收益：Llama-2-7b、Llama-2-13b、Llama-2-70b等使用流水线并行PP配置训练的模型，叠加本算法后平均峰值内存减少11.5%，平均性能劣化小于1%。性能优化模块收益：Llama-2-7b、Llama-2-13b、Llama-3-8b等使用流水线并行PP配置训练的模型，叠加本算法后平均性能提升7.6%。
