...
<p align="left"> <img src="../figures/async_ddp.png" height="250px" width="680px" style="display:block;"></p>
...
异步DDP通过实现计算与通信任务的重叠执行，显著改善了大模型训练中的资源利用率和训练效率，对于Llama-2-70b模型，端到端性能提升约2-3%。
