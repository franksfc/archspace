...
def chunk_gated_delta_rule_fwd_h_ref(
    ...
    BV = 64
    chunk_gated_delta_rule_fwd_kernel_h_blockdim64_ref[(triton.cdiv(V, BV), N * H)](
        k=k,
        v=u,
        w=w,
        v_new=v_new,
...
def test_chunk_gated_delta_rule_fwd_h(B, T, H, D, chunk_size, cu_seqlens):
    ...
    ref_h_npu, ref_v_new_npu, _ = chunk_gated_delta_rule_fwd_h_ref(
        k=k,
        w=w,
        u=u,
        g=g,
    ...
    h_npu, v_new_npu, _ = chunk_gated_delta_rule_fwd_h(
        k=k,
        w=w,
        u=u,
        g=g,
