...
class TestNpuDropoutAddLayerNorm:
    ...
    def custom_op_exec(
        ...
        if is_rms_norm:
            return npu_dropout_add_rms_norm(
                x0,
                residual,
                weight,
                bias,
            ...
            return npu_dropout_add_layer_norm(
                x0,
                residual,
                weight,
                bias,
    ...
    def test_npu_dropout_add_layer_norm(self):
        ...
        output_cpu = self.supported_op_exec(
            x0,
            weight,
            residual,
            bias,
        ...
        output_custom = self.custom_op_exec(
            x0,
            weight,
            residual,
            bias,
