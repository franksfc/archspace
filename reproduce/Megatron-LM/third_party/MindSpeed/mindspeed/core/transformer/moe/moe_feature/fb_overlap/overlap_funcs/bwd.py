...
from ..modules.utils import prefetch_dense_fc1_swap_in, run_graph_backward
...
def transformer_layer_backward_dense(layer_output_grad, layer_graph):
    # Fallback for callers that do not prefetch at the transformer-block level.
    prefetch_dense_fc1_swap_in(layer_graph)
