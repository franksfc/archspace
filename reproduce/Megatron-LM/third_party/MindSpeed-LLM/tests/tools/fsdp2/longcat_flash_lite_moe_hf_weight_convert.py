...
def save_model_safetensors(src_dir, dst_dir):
    ...
    model_safetensors_index = {metadata_key: {}, weight_map_key: {}}
    ...
    moe_expert_dim = config["expert_ffn_hidden_size"]
...
def main():
    parser = argparse.ArgumentParser(
        description='Merge Qwen3-Next-MoE experts params.', allow_abbrev=False, conflict_handler='resolve'
    )

    parser.add_argument("--load-dir", type=str, default=None, required=True, help="Original Qwen3-Next-MoE HF path.")
    parser.add_argument("--save-dir", type=str, default=None, required=True, help="Save Qwen3-Next-MoE param path.")
    ...
    file_copy(src_dir=src_dir, file_name='configuration_longcat_ngram.py', dst_dir=dst_dir)
    file_copy(src_dir=src_dir, file_name='model_hashes.txt', dst_dir=dst_dir)
    file_copy(src_dir=src_dir, file_name='modeling_longcat_ngram.py', dst_dir=dst_dir)
    file_copy(src_dir=src_dir, file_name='parse_model_response.py', dst_dir=dst_dir)
    ...
    file_copy(src_dir=src_dir, file_name='special_tokens_map.json', dst_dir=dst_dir)
    file_copy(src_dir=src_dir, file_name='tech_report.pdf', dst_dir=dst_dir)
