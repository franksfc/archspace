...
NPUS_PER_NODE=8
MASTER_ADDR=localhost #主节点IP，多机训练时请修改为实际主节点IP或通过环境变量传入
MASTER_PORT=6066
NNODES=8              # 请根据实际节点数量修改
NODE_RANK=0           # 请根据实际节点Rank修改，或通过环境变量传入
...
torchrun $DISTRIBUTED_ARGS pretrain_gpt.py \
    ...
    --load ${CKPT_LOAD_DIR} \
    --save ${CKPT_SAVE_DIR} \
    --distributed-backend nccl | tee logs/pretrain_longcat_flash_19.9b_8k_bf16_A5_ptd_perf.log
