...
class TestUtils(unittest.TestCase):
    ...
    def test_train_valid_test_datasets_provider_ldt_instruction_dataset(
        self,
        mock_builder,
        mock_build_datasets,
        mock_print,
    ...
    @mock.patch('mindspeed_llm.tasks.posttrain.ldt_sft.utils.print_rank_0')
    @mock.patch('mindspeed_llm.tasks.posttrain.ldt_sft.utils.BlendedMegatronDatasetBuilder')
    def test_train_valid_test_datasets_provider_ldt_normal_dataset(
        self, mock_builder, mock_print, mock_gpt_dataset, mock_mock_dataset, mock_config_from_args, mock_get_args
    ):
        # Setup mock return values
        mock_args = mock.MagicMock()
    ...
    def test_build_train_valid_test_datasets_internal(
        self, mock_dataset, mock_print, mock_split, mock_get_indexed_dataset
    ):
        # Setup mock return values
    ...
    @mock.patch('mindspeed_llm.tasks.posttrain.ldt_sft.utils.get_vdp_manager')
    ...
    def test_build_index_mappings(
        self,
        mock_np_load,
        mock_check_equal,
        mock_get_world_size,
        mock_all_reduce,
        mock_get_pipeline_group,
        mock_get_tensor_group,
        mock_get_context_group,
        mock_get_data_group,
        mock_get_vdp_manager,
        mock_is_vtp,
        mock_long_tensor,
        mock_barrier,
        mock_np_save,
        mock_random_shuffle,
        mock_build_sequential,
        mock_build_shuffle,
        mock_print,
        mock_isfile,
        mock_device_count,
        ...
        mock_get_vdp_manager.return_value = None  # non-VDP scenario
