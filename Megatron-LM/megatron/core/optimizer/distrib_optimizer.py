...
class DistributedOptimizer(MixedPrecisionOptimizer):
    ...
    def get_grad_stats_parallel_group(self) -> torch.distributed.ProcessGroup:
        ...
        one complete set of parameter shards.

        Partial distributed optimizer replicates those shards across optimizer
        instances, so its factory attaches the orthogonal intra-instance
        DP+CP and model-parallel groups. ``None`` retains the stock
        single-instance world reduction.
        """
