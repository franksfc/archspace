# MindSpeed Ascend HDK 路径批量替换指南

## 背景

MindSpeed 仓库中的 Docker 挂载配置、运行脚本等存在硬编码的 `/usr/local/Ascend/driver/` 路径引用。
...
| Markdown 文档（`.md`） | 全量说明文档，包括但不限于：安装指南、快速上手、各任务指南、特性说明等 | `docs/zh/user-guide/install_guide.md`、`docker/OVERVIEW.md` |
