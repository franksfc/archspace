...
torchrun $DISTRIBUTED_ARGS train_fsdp2.py examples/fsdp2/qwen3/pretrain_qwen3_14b_4k_fsdp2_A3.yaml \
    --model.model_name_or_path /home/hf_weights/Qwen3-14B/ \
    ...
    | tee ./logs/fsdp2_qwen3_14b_pretrain_${TIMESTAMP}.log
