...
FSDP2 通过 `MixedPrecisionPolicy` 提供了灵活的精度控制，严格区分 **存储精度**、**计算精度**和**通信精度**。
...
本文示例基于PyTorch 2.7及以上版本；FSDP2自PyTorch 2.4起以技术预览形式引入。

**参考来源**：[PyTorch FSDP2 Documentation](https://docs.pytorch.org/docs/stable/distributed.fsdp.fully_shard.html)
