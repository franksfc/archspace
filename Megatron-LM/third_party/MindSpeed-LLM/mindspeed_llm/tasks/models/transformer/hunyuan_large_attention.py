...
try:
    ...
    try:
        from transformers.utils.fx import is_torch_fx_available
    except ImportError:
        is_torch_fx_available = None
...
if is_torch_fx_available is not None and is_torch_fx_available():
...
class HunyuanLargeAttention(SelfAttention):
    ...
    def __init__(
        ...
        super().__init__(config=config, submodules=submodules, layer_number=layer_number, attn_mask_type=attn_mask_type)
