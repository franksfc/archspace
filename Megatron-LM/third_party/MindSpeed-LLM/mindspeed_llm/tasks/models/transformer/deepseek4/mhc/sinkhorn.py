    ...
    class HcSplitSinkhornFunction(torch.autograd.Function):
        ...
        def backward(
            ...
            grad_mixes_triton, grad_scale_triton, grad_base_triton = hc_split_sinkhorn_backward(
                grad_pre, grad_post, grad_comb, mixes, hc_scale, hc_base, hc_mult, sinkhorn_iters, eps
            )
...
def hc_split_sinkhorn_triton(
    ...
    pre, post, comb = HcSplitSinkhornFunction.apply(mixes, hc_scale, hc_base, hc_mult, sinkhorn_iters, eps)  # pylint:disable=possibly-used-before-assignment
    return pre, post, comb
