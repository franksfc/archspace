...
class UShapedSplitFeature(MindSpeedFeature):
    def __init__(self):
        super().__init__(feature_name="u-shaped-split", optimization_level=0)
    ...
    def register_patches(
        ...
        if getattr(args, "layerwise_disaggregated_training", None):
            from mindspeed_llm.core.layerwise_disaggregated_training.schedules import (
            ...
            from mindspeed_llm.core.layerwise_disaggregated_training.p2p_communication import (
                _communicate,
                send_backward,
                send_forward,
            )
            ...
            patch_manager.register_patch(
                "megatron.core.pipeline_parallel.schedules.get_forward_backward_func", get_forward_backward_func
            )
            patch_manager.register_patch(
            ...
            patch_manager.register_patch(
                "megatron.core.pipeline_parallel.p2p_communication.send_backward", send_backward
            )
